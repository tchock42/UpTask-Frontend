...
const ProjectTeamView = () => {
    ...
    const params = useParams()              // lee la url para extraer el projectId
    ...
    if(data) return (
        //retorna el componente con los colaboradores
        <>
            ...
            <nav className="my-5 flex gap-3">
                <button
                    ...
                    onClick={() => navigate('?addMember=true')}           // agrega al final de la url 'newTask=true'
