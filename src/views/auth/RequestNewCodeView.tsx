...
export default function RegisterView() {
    ...
    const { register, handleSubmit, reset, formState: { errors } } = useForm({ defaultValues: initialValues }); // gestion del formulario

    const {mutate} = useMutation({
        mutationFn: requestConfirmationCode, // servicio que comunica con la API
        onError: (error) => {
