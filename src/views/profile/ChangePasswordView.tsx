...
export default function ChangePasswordView() {
  const initialValues: UpdateCurrentUserPasswordForm = {      // inicial con string vacíos
    current_password: '',
    password: '',
  ...
  const password = watch('password');         // revisa que las contraseñas sean iguales, si no, genera el error
